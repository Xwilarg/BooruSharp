...
namespace BooruSharp.Search
{
    ...
    public class AuthentificationInvalid : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthentificationInvalid"/>
        /// class with a specified error message.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        public AuthentificationInvalid(string message)
            : base(message)
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="AuthentificationInvalid"/> class with a specified
        ...
        public AuthentificationInvalid(string message, Exception innerException)
        ...
        protected AuthentificationInvalid(SerializationInfo info, StreamingContext context)
            : base(info, context)
        { }
    }
}
